...
if(!isset($_POST['nom']) || $_POST['nom']==="" || !isset($_POST['prenom']) || $_POST['prenom']==="" ||  !isset($_POST['email']) || $_POST['email']==="" || !isset($_POST['planet']) || $_POST['planet']==="" || !isset($_POST['category']) || !isset($_POST['date1']) || !isset($_POST['date2']))
{
